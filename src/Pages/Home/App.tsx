...
export default function App() {
  ...
  return (
    /* 1. O container que permite ver o fundo escuro do body */
    <div className="min-h-screen pb-20">
      <Header />

      {/* 2. O main centralizado que contém todo o seu portfólio */}
      <main className="flex-1 max-w-4xl mx-auto w-full bg-white p-6 md:p-12 mt-10 rounded-xl shadow-2xl z-10">
        {/* Seção Sobre Mim */}
        <section className="flex flex-col items-center">
          ...
          <article className="text-gray-800 leading-relaxed text-justify space-y-6">
            ...
            <p>
              ...
              resolução de problemas complexos, sustentação de sistemas e apoio
              direto ao desenvolvimento.
              <br />
              <br />
              Atualmente, na Ágape Consultoria e no Grupo Coutinho, foco em
              garantir a estabilidade de produtos digitais através de testes de
              QA, manipulação de JSON e suporte técnico especializado.
              <br />
              <br />
              Minha base técnica foi construída através de experiências em Field
              Service, Automação e Administração de Redes, gerenciando ambientes
              Windows/Linux, servidores e ferramentas como Active Directory e
              ERP TOTVS (Consinco).
              <br />
              <br />
              Essa bagagem me permite ter uma visão 360° do ciclo de vida de um
              software, desde a infraestrutura até a experiência do usuário
              final. Diferencial Militar: Servi por 4 anos no Exército
              Brasileiro, onde consolidei competências críticas de liderança,
              disciplina rigorosa, resiliência e a capacidade de tomar decisões
              rápidas sob pressão — habilidades que aplico diariamente na
              resolução de incidentes críticos de TI.
              <br />
              <br />
            ...
            <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-black italic">
              <strong>Objetivo:</strong> Atuar como Desenvolvedor de Software ou
              Analista de Sistemas, unindo minha experiência em sustentação com
              a criação de novas soluções tecnológicas.
            </div>
          </article>
        </section>

        {/* Linha divisória nativa */}
        <hr className="my-12 border-gray-200" />

        {/* Seção de Projetos/Repositórios */}
        {repos?.length > 0 && (
          <section>
